...
<Route path="/attendance" element={<AttendancePage onMobileMenuToggle={toggleMobileMenu} />} />
                ...
                <Route path="/settings" element={<ComingSoonPage title="Settings" subtitle="Configure system preferences and options" icon="Settings" description="System configuration panel will allow you to customize application settings, user preferences, and institutional parameters." onMobileMenuToggle={toggleMobileMenu} />} />
              </Routes>
            </div>
            <ToastContainer position="top-right" autoClose={3000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover className="toast-container" style={{
              zIndex: 9999
            }} />
          </div>
        } />
